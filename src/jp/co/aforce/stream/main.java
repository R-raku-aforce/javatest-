        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            br.lines()
              ...
              .map(fields -> {
                  ...
                  return new Personnow(id, name, gender, age, occupation);
              })
              .sorted(Comparator.comparingInt(Personnow::getAge)) // 年齢で昇順にソート
...
class Personnow {
    ...
    public Personnow(int id, String name, String gender, int age, String occupation) {
        this.id = id;
        this.name = name;
        this.gender = gender;
        this.age = age;
